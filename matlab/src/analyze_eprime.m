...
% % Rates for combined runs 1+2, 3+4
% summary.Run12_WinStayPct = ...
% 	100 * (summary.Run1_WinStay + summary.Run2_WinStay) / ...
% 	(summary.Run1_WinStay + summary.Run2_WinStay + ...
% 	summary.Run1_WinSwitch + summary.Run2_WinSwitch);
% summary.Run12_WinSwitchPct = ...
% 	100 * (summary.Run1_WinSwitch + summary.Run2_WinSwitch) / ...
% 	(summary.Run1_WinStay + summary.Run2_WinStay + ...
% 	summary.Run1_WinSwitch + summary.Run2_WinSwitch);
% summary.Run12_LoseStayPct = ...
% 	100 * (summary.Run1_LoseStay + summary.Run2_LoseStay) / ...
% 	(summary.Run1_LoseStay + summary.Run2_LoseStay + ...
% 	summary.Run1_LoseSwitch + summary.Run2_LoseSwitch);
% summary.Run12_LoseSwitchPct = ...
...
% 	summary.Run3_WinSwitch + summary.Run4_WinSwitch);
% summary.Run34_WinSwitchPct = ...
% 	100 * (summary.Run3_WinSwitch + summary.Run4_WinSwitch) / ...
% 	(summary.Run3_WinStay + summary.Run4_WinStay + ...
% 	summary.Run3_WinSwitch + summary.Run4_WinSwitch);
% summary.Run34_LoseStayPct = ...
% 	100 * (summary.Run3_LoseStay + summary.Run4_LoseStay) / ...
% 	(summary.Run3_LoseStay + summary.Run4_LoseStay + ...
% 	summary.Run3_LoseSwitch + summary.Run4_LoseSwitch);
% summary.Run34_LoseSwitchPct = ...
% 	100 * (summary.Run3_LoseSwitch + summary.Run4_LoseSwitch) / ...
% 	(summary.Run3_LoseStay + summary.Run4_LoseStay + ...
% 	summary.Run3_LoseSwitch + summary.Run4_LoseSwitch);
