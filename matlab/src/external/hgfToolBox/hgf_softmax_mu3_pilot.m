...
function [out] = hgf_softmax_mu3_pilot

% Load data set.
load('/Volumes/psr/Woodward_Lab/Julia/ResearchProjects/BeliefUpdating/Tasks/PRL-master/analysis/julia/pilotdata/4006/PRL.mat');
